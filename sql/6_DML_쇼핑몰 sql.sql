...
# MEMBER 테이블의 권한은 일반회원 : USER, 관리자는 ADMIN
# 아이디가 ADMING이고, 비번이 ADMIN, 이메일이 ADMIN@GAMIL.COM, 번호가 010-0000-0000인 관리자가 
# 회원가입을 했을 때 필요한 쿼리

INSERT INTO MEMBER VALUES("ADMIN","ADMIN","ADMIN@GAMIL.COM", "010-0000-0000", "ADMIN",0);
...
코드 : FOOO001, 제품명 : 만두, 	내용 : 고기만두, 			가격 : 10000, 		카테고리 : 식품 4
코드 : FOOO002, 제품명 : 라면,	내용 : 맛있는 라면, 		가격 : 3000, 		카테고리 : 식품 4
코드 : CARO001, 제품명 : 방향제, 내용 : 향기 좋음,		 	가격 : 5000, 		카테고리 : 자동차 5
...
("CLO002", "셔츠", "구김이 없는 셔츠" , 50000, 3),
("FOOO001", "만두", "고기만두", 10000, 4),
("FOOO002" , "라면",	"맛있는 라면",3000, 4),
("CARO001", "방향제", "향기 좋음", 5000, 5);

# 아이디 : ABC123, 비번 : ABC123, 이메일 ABC123@KH.COM 번호 : 011-0000-0000
# 아이디 : QWE123, 비번 : QWE123, 이메일 QWE123@KH.COM 번호: 011-2222-2222

INSERT INTO MEMBER(ME_ID, ME_PW, ME_EMAIL, ME_PHONE) VALUES
("ABC123","ABC123","ABC123@KH.COM","011-0000-0000"),
("QWE123","QWE123","QWE123@KH.COM","011-2222-2222");

# ABC123 회원이 마우스를 장바구니에 2개 담았을 때 실행되는 쿼리
INSERT INTO BASKET(BA_AMOUNT,BA_ME_ID,BA_PR_CODE) VALUES
(2,"ABC123","ELC001");

#ABC 123회원이 마우스를 장바구니에 3개 담았을 때 실행되는 쿼리
UPDATE BASKET 
SET 
    BA_AMOUNT = 3
WHERE
...
# ABC 123 회원이 키보드를 장바구니에 1개 담았을 때 실행되는 쿼리
