...
public class ArrayMethodEx1 {
	...
	public static void main(String[] args) {
		...
		//1 ~ 45 사이의 중복되지 않은 수 6개를 입력하는 코드를 작성하세요.(contains 메서드 이용)
		int user[] = new int[6];
		int count =0;
		Scanner scan =new Scanner(System.in);
		
		System.out.println("정수 6개 입력(중복X, 1~45) : ");
