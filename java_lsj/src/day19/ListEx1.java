...
public class ListEx1 {
	...
	public static void main(String[] args) {
		 ...
		 *  - get()을 이용할 때 클래스 형변환 을 해야함
		 * 
		 *  - get(번지) : 리스트에서만 제공하는 메서드
		 */
		List list = new ArrayList();
		list.add("abc");
		String str = (String)list.get.Item(0);
		...
		/*list 3는 List인터페이스를 구현한 구현 클래스들의 객체
		 * 중 아무나 올 수 있다.
		 ...
		 * remove(객페) : Collectin, 객체와 일치하는 요소를 제거 후 제거 여부를 반환
		 */
		list.remove(0);
		list.remove("def");
		...
		/* forEach() : Colletion, 람다식을 이용하여 컬렉션에서 하나 꺼낸 값을 활용할 때 사용
		 * */
