...
function App() {
    ...
    <BrowserRouter>
        <ul className="menu-list">
            <li><Link to="/">메인</Link></li> {/*Link은 a태그와 같은 기능*/}
...
function Insert(){
    ...
    return(
        ...
        <br/>
        <input type="text"placeholder="작성자"onChange={(e)=>setTitle(e.target.value)}/>
        <br/>
        <textarea placeholder="내용"onChange={(e)=>setTitle(e.target.value)}></textarea>
         <br/>
         <button onClick={insertPost}>게시글등록</button>
    </div>
    );
}
