...
<jsp:include page="/WEB-INF/views/header.jsp"/>
		...
		<form action="<%= request.getContextPath() %> /signup" method="post">
			...
			<div class="mb-3 mt-3">
				<label for="pw" class="form-label">비밀번호:</label> <input
					type="password" class="form-control" id="pw" placeholder="비번"
					name="pw">
			</div>
			<div class="mb-3 mt-3">
				<label for="pw2" class="form-label">비번확인:</label> <input
					type="password" class="form-control" id="pw2" placeholder="비번"
					name="pw2">
			</div>
			<div class="mb-3 mt-3">
				<label for="email" class="form-label">이메일:</label> <input
					type="text" class="form-control" id="email" placeholder="비번"
					name="email">
			</div>
	...
	<script type="text/javascript">
			...
			//아이디가 바뀌면 false로 바꿔서 아이디 검사를 다시 하도록
