		...
		<div class="mb-3 mt-3">
    			...
    			<select class = "form-control" name = "community" id= "community">   			
    				<c:forEach items ="${list}" var = "community">
    					<option value = "${community.co_num}">${community.co_name }<c:if test="${board.bo_co_num == community.co_num }">selected</c:if>
    					</option>
    				</c:forEach>
    			</select>
			...
			<div class="mb-3 mt-3">
  			...
  			<div class="mb-3 mt-3">
    			...
    			<textarea rows= "20" class="form-control" id="content" placeholder="내용" name="content">${board.bo_content}</textarea>
  			</div>
